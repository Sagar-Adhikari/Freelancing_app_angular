...
export class TestimonialsComponent implements OnInit {
    ...
    displayedColumns = ['index', 'author', 'position', 'created', 'status', 'action'];
	TestyDatabase: TestpyHttpDao | null;
	data: TestlistData[] = [];
	...
	ngOnInit() {
		this.TestyDatabase = new TestpyHttpDao(this.http);
...
export class TestpyHttpDao {
	...
	getPyapi(sort: string, order: string, page: number, filter: string=''): Observable<TestApi> {
		const href = constant.apiurl + constant.admintestimonials;
