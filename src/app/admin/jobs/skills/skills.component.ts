...
export class SkillsComponent implements OnInit {
  ...
  displayedColumns = ['index', 'category_name', 'name', 'status', 'action'];
...
export class JobspyHttpDao {
  ...
  getPyapi(sort: string, order: string, page: number, filter: string=''): Observable<JobsApi> {
    const href = constant.apiurl + constant.adminskills;
